...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/uploads/' . $_SESSION['RF']['folder'] . '/files/',
	/*
	|--------------------------------------------------------------------------
	...
	|
	*/
	'current_path' => '../uploads/' . $_SESSION['RF']['folder'] . '/files/',
	...
	|
	*/
	'thumbs_base_path' => '../uploads/' . $_SESSION['RF']['folder'] . '/thumbs/',
	...
	*/
	...
	|--------------------------------------------------------------------------*/
	'ftp_thumbs_dir' => '/uploads/' . $_SESSION['RF']['folder'] . '/thumbs/',
	'ftp_ssl' => false,
	'ftp_port' => 21,
	...
	*/
	...
	'access_keys' => array($_SESSION['RF']['akey']),
	...
	*/
	...
	'lazy_loading_file_number_threshold'	=> 10,
